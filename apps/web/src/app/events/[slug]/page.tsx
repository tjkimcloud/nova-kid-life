...
function buildSeoTitle(event: Event): string {
  ...
  const maxTitle = 60 - suffix.length // chars left for event title
...
function buildMetaDescription(event: Event): string {
  ...
  // Build, then trim to 155 chars at a word boundary
    ...
    <>
      ...
      <main className="min-h-screen bg-primary-50/30">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
          ...
          <section aria-labelledby="details-heading">
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-xl border border-secondary-100 p-4 flex gap-3">
                <CalendarIcon />
                <div>
                  <dt className="text-xs font-semibold text-secondary-400 uppercase tracking-wide">
                    Date &amp; Time
                  </dt>
                ...
                <div>
                  ...
                  <dd className="mt-0.5 text-secondary-800 font-medium text-sm">
                    ...
                    {event.location_address && (
                      <span className="block text-secondary-500 font-normal">
                        {event.location_address}
                      </span>
                    )}
                    <span className="block text-secondary-500 font-normal">
          ...
          {event.registration_url && (
            <section aria-labelledby="register-heading">
              ...
              <p className="text-secondary-600 mb-4 text-sm">
                Registration is required for this event. Spots may be limited — register early to secure your place.
              </p>
              <a
          ...
          {/* ── FAQ (GEO: visible Q&As for AI systems) ── */}
