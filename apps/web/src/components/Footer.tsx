  ...
  return (
    <footer className="bg-secondary-100 border-t border-secondary-200">
      <div className="max-w-5xl mx-auto px-5 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-secondary-200">

          {/* Brand */}
          <div>
            <p className="font-heading font-extrabold text-[19px] tracking-[-0.5px] text-secondary-900 mb-2">
            ...
            <p className="text-sm font-body text-secondary-500 leading-relaxed mb-4">
              ...
              Updated weekly from 100+ local sources — completely free.
            </p>
          ...
          {/* Coverage */}
          <div>
            <h2 className="font-heading font-extrabold text-xs uppercase tracking-wider text-secondary-400 mb-3">
              Coverage Area
            </h2>
            <ul className="space-y-1.5 text-sm font-body text-secondary-500">
        ...
        <p className="pt-6 text-xs font-body text-secondary-400 text-center">
